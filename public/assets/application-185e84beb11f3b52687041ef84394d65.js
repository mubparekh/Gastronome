...
function displayMatches(array)
{
	...
	var inputVal = document.getElementById("Ingredient").value;
	var matches = [];
	if (inputVal.length > 2)
	{
		for (i = 0; i < array.length; i++)
		{
			if (array[i].name.indexOf(inputVal) !== -1)
			{
		...
		{	
			...
			{
				$(element).append("<a href=\"ingredient/" + matches[i].name + "\">" + matches[i].name + "</span></br>");
			}
		}
	}
}
